            ...
            {courses.map((course) => {
              ...
              return (
                ...
                >
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger
                      className="h-6 w-6 shrink-0 ml-1 opacity-0 group-hover:opacity-100 cursor-pointer text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-md transition-all flex items-center justify-center"
