...
2. ${fallback ?? `Phần không chắc chắn đánh dấu: "⚠️ Transcript không rõ: [nội dung suy luận]"`}
...
- Nội dung quá ngắn/không rõ: ghi "⚠️ Transcript ngắn/không rõ, tóm tắt dựa trên nội dung hiện có"
...
**Giai đoạn 1: Nền tảng** (trước khóa) — Mỗi chủ đề: tại sao cần, ⏱️ thời gian, 📚 tài nguyên, ✅ tiêu chí hoàn thành.
...
1-2 dự án kết hợp toàn khóa: mô tả, kỹ năng rèn luyện, yêu cầu, ⏱️ thời gian, 💡 gợi ý.
...
## LOẠI BÀI TẬP
1. **Tái hiện** (1 bài, ⭐): tái tạo đúng những gì đã học — xác nhận nắm kiến thức cơ bản
2. **Mở rộng** (1-2 bài, ⭐⭐): lấy kiến thức bài + mở rộng/thay đổi/áp dụng tình huống khác
...
## XỬ LÝ TRANSCRIPT
- Trích xuất ý nghĩa, KHÔNG sao chép nguyên văn. Code/công thức: nêu tên khái niệm, không cần code block
- Nội dung quá ngắn/không rõ: "⚠️ Transcript ngắn/không rõ, tóm tắt dựa trên nội dung hiện có"
